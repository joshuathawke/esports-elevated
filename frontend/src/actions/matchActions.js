...
export const matchList = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get("/api/matches/create", config);
...
export const createMatch =
  (team1, team2, start_time, end_time) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.post(
        "/api/matches/create",
        { team1, team2, start_time, end_time },
        config
      );
...
export const updateMatch =
  (id, team1, team2, start_time, end_time) => async (dispatch, getState) => {
    try {
