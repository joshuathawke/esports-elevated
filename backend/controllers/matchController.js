...
const createMatch = asyncHandler(async (req, res) => { 
    const { team1_id, team2_id, start_time, end_time } = req.body;
    
    if (!team1_id || !team2_id || !start_time || !end_time) {
        res.status(400);
        throw new Error('Please enter all fields');
    }
    else {
        const match = new Match({ userId: req.user._id, team1_id, team2_id, start_time, end_time });
